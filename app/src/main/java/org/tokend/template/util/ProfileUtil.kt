...
object ProfileUtil {
    ...
    fun getAvatarUrl(activeKyc: ActiveKyc?,
                     ...
                     email: String?): String? {
        val formData = (activeKyc as? ActiveKyc.Form)?.formData
        val avatar = (formData as? KycForm.Corporate)?.avatar
    ...
    fun getDisplayedName(activeKyc: ActiveKyc?, email: String): String? {
        return when (val form = (activeKyc as? ActiveKyc.Form)?.formData) {
